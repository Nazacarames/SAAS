...
_CONTACT_COLS = (
    ...
    # de donde vino el lead: la tabla de Leads lo muestra por fila
    'origen, origen_detalle, campaign_name, ad_name, '
...
def _qualified_cols(alias: str) -> str:
    ...
    plain = [
        ...
        "ai_paused", "origen", "origen_detalle", "campaign_name", "ad_name",
    ]
