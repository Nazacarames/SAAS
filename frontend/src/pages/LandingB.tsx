...
const PLANS = [
  {
    ...
    price: 'USD 129',
    period: '/mes',
    description: 'Precio competitivo para equipos que arrancan y quieren orden comercial desde WhatsApp.',
    cta: 'Empezar prueba gratis',
    highlight: false,
    bullets: ['1 número WhatsApp', '2 agentes', '1 bot IA', '1.500 conversaciones/mes']
  },
  {
    name: 'Pro',
    price: 'USD 229',
    period: '/mes',
    description: 'El plan más elegido para escalar ventas y mejorar conversión con control operativo.',
    cta: 'Probar 14 días gratis',
    highlight: true,
    bullets: ['5 agentes', 'IA avanzada + guardrails', 'Meta + webhooks', '6.000 conversaciones/mes']
  },
  {
    name: 'Scale',
    price: 'Desde USD 399',
    period: '/mes',
    description: 'Para operaciones de alto volumen con soporte prioritario y acompañamiento estratégico.',
    cta: 'Hablar con especialista',
    highlight: false,
    bullets: ['10 agentes', '15.000 conversaciones/mes', 'SLA + CSM dedicado', 'Integraciones custom']
  }
];
      ...
      <Container maxWidth='md'>
        ...
        <Stack spacing={3} sx={{ textAlign: 'center', mb: { xs: 5, md: 7 } }}>
          <Stack direction='row' justifyContent='center'>
            <Chip
              label='Reducí fuga de leads y cerrá más ventas'
          ...
          <Typography variant='h2' sx={{ fontWeight: 900, fontSize: { xs: '2rem', md: '3.5rem' }, lineHeight: 1.05 }}>
            Convertí más consultas
            <br />
            en ventas reales
          </Typography>

          <Typography sx={{ color: 'rgba(226,232,240,.9)', maxWidth: 900, mx: 'auto', fontSize: { xs: '1rem', md: '1.2rem' } }}>
            Respondé más rápido, recapturá leads caídos y escalá tu operación comercial con un tablero que te muestra exactamente dónde ganar conversiones.
          </Typography>
            ...
            <Grid item xs={12} md={6} key={item.title}>
              ...
              >
                <Stack spacing={1.1} alignItems='center' textAlign='center'>
                  ...
                  <Typography variant='body2' sx={{ color: 'rgba(226,232,240,.82)', maxWidth: 420 }}>
                    {item.description}
                  </Typography>
                </Stack>
              </Paper>
        ...
        <Paper sx={{ mb: 7, p: { xs: 2.2, md: 3 }, borderRadius: 3, border: '1px solid rgba(125,211,252,.28)', background: 'rgba(2,12,32,.8)', textAlign: 'center' }}>
          ...
          <Grid container spacing={2}>
            {[
              ...
              <Grid item xs={12} md={4} key={t}>
                ...
                <Typography variant='body2' sx={{ color: 'rgba(226,232,240,.8)', maxWidth: 280, mx: 'auto' }}>{d}</Typography>
              </Grid>
            ))}
          </Grid>
        </Paper>
        ...
        <Typography sx={{ textAlign: 'center', color: 'rgba(226,232,240,.82)', mb: 3.2 }}>
          Precios competitivos frente al mercado, con foco en rentabilidad y escalabilidad.
        </Typography>
        ...
        <Paper sx={{ p: 2.2, mb: 6, borderRadius: 3, border: '1px solid rgba(125,211,252,.22)', background: 'rgba(2,12,32,.65)' }}>
          ...
          <Stack direction='row' spacing={1} useFlexGap flexWrap='wrap' sx={{ mt: 2 }}>
            {['Agente extra: USD 19/mes', 'Conversación extra: USD 0.08', 'Número extra: USD 39/mes', 'Soporte premium: USD 99/mes'].map((addon) => (
              <Chip key={addon} label={addon} variant='outlined' sx={{ borderColor: 'rgba(125,211,252,.4)', color: '#BAE6FD' }} />
            ))}
          </Stack>
        </Paper>
